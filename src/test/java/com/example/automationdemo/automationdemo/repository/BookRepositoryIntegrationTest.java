 ...
 * Unlike the repository tests with H2, these tests run against the same
 * PostgreSQL version we'll use in production, ensuring full compatibility.
 */
@DataJpaTest
@Testcontainers
...
public class BookRepositoryIntegrationTest {
    ...
    /**
     * Configure Spring datasource properties to point to the Testcontainers PostgreSQL instance.
     * This is a static method that will be called once during test context initialisation.
     */
    ...
    void testFullTextSearch_WithPostgresSpecificFeatures() {
        ...
        book1.setDescription("A hobbit goes on an adventure with dwarves to reclaim their treasure from a dragon.");
        bookRepository.save(book1);

        Book book2 = createTestBook("The Fellowship of the Ring", "J.R.R. Tolkien", "Fantasy");
        book2.setDescription("A hobbit must destroy a powerful ring to save Middle-earth from the Dark Lord Sauron.");
        bookRepository.save(book2);

        Book book3 = createTestBook("Dune", "Frank Herbert", "Science Fiction");
        book3.setDescription("A desert planet is the only source of a valuable spice, and political factions fight for control.");
    ...
    /**
     * Test PostgreSQL's case-insensitive search capabilities.
     * This is important to test with PostgreSQL specifically, as different databases
     * handle case sensitivity differently.
     */
    @Test
     ...
     * This is important to test with real PostgreSQL, as database
     * collations and character handling can vary.
     */
    @Test
